...
import com.example.mytest.activity.Video.VideoControl;

/**
 * Created by gaopeng on 2017/1/17.
 */
...
//                                mActivity.setRequestedOrientation(1);
        ...
        public static ScreenSwitchUtils init(Context context , VideoControl videoControl) {
            if (mInstance == null) {
                synchronized (ScreenSwitchUtils.class) {
                    if (mInstance == null) {
                        mInstance = new ScreenSwitchUtils(context , videoControl);
                    }
                }
            }
            return mInstance;
        ...
        private ScreenSwitchUtils(Context context , VideoControl videoControl) {
